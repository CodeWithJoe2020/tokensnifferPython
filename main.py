...
factoryContract = web3.eth.contract(factoryMainnet,abi=panFacAbi)
...
def testSell():
    ...
    contractRouter = web3.eth.contract(address=routerMainnet, abi=routerAbi)
    #Token to buy 
